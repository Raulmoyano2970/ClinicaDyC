        ...
        <div className='max-w-2xl mx-auto w-full'>
            ...
            <form onSubmit={handleSubmit} className=''>
                <div className=''>
                    ...
                    <div>
                        <p>DIETA RICA EN FIBRA, 30 GR DÍA </p>
                    </div>
                    <div>
                        <p>LIQUIDOS 2 – 2.5 LITROS DIA </p>
                    </div>
                    <div>
                        <p>SUPLEMENTO DE FIBRA BARRA O POLVO  </p>
                    </div>
                    <div>
                        <p>CONTUMAX 1 SOBRE DISUELTO EN 250 CC DE AGUA 1 VEZ EN LA MAÑANA </p>
                    </div>
                </div>
